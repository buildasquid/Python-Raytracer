...
from ray import Ray # type: ignore
from point import Point # type: ignore
from color import Color

class RenderEngine:
    """renders 3D obj into 2D obj using ray tracing"""
    MAX_DEPTH = 5
    MIN_DISPLACE = 0.0001
    ...
    def ray_trace(self,ray,scene,depth=0):
        color=Color(0,0,0)
        #find nearest obj hit by the ray in the scene
        ...
        if depth < self.MAX_DEPTH:
            ...
            #reflected ray found by reflection coefficient is attenuated
